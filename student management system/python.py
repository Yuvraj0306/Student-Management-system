...
connector.execute(
    "CREATE TABLE IF NOT EXISTS SCHOOL_MANAGEMENT (STUDENT_ID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, NAME TEXT, "
    ...
    if not name or not email or not contact or not gender or not DOB or not stream:
        ...
        try:
            ...
            mb.showerror('Wrong type',
                         'The type of the values entered is not accurate. Pls note that the contact field can only '
                         'contain numbers')
